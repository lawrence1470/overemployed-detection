		...
		<main className="min-h-screen bg-black">
			...
			<div className="relative z-10 flex min-h-screen items-center justify-center px-4 py-20">
				<div className="mx-auto max-w-4xl">
					...
					>
						<div className="mb-6 inline-flex items-center gap-2 rounded-full bg-purple-500/20 px-4 py-2 font-medium text-purple-300 text-sm">
						...
						>
							Join forward-thinking companies protecting their workforce
							integrity. Skip the waitlist and start using VerifyHire
							immediately.
						</p>
					</motion.div>
					...
					<div className="mb-12 grid gap-8 md:grid-cols-2">
						...
						>
							...
							<div className="mb-6">
								<span className="font-bold text-5xl text-white">$499</span>
								<span className="ml-2 text-white/60">one-time payment</span>
							</div>
						...
						>
							...
							<div className="mt-8 rounded-xl border border-white/10 bg-white/5 p-6">
								...
								<p className="text-white/60 text-xs">
									By purchasing early access, you agree to our Terms of Service
									and Privacy Policy.
								</p>
							</div>
						</motion.div>
