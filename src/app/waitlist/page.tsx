...
function StatsTicker() {
	...
	return (
		<div className="pointer-events-none absolute top-20 right-0 left-0 overflow-hidden sm:top-24">
			<motion.div
...
export default function WaitlistPage() {
	...
	return (
		<main className="relative min-h-screen bg-black">
			...
			{/* Main Content */}
			<div className="relative z-10 flex min-h-screen items-center justify-center px-4 pt-32 pb-8 sm:pt-20">
