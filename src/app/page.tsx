...
export default function Home() {
	...
	return (
		<main ref={containerRef} className="relative overflow-hidden">
			...
			<AnimatedSection direction="up" delay={0.1} className="relative z-10">
				<div className="relative overflow-hidden bg-gradient-to-b from-white to-gray-50 py-20 dark:from-gray-900 dark:to-gray-950">
			...
			<AnimatedSection direction="right" delay={0.3} className="relative z-10">
				<div className="relative bg-gradient-to-b from-gray-50 to-white py-20 dark:from-gray-950 dark:to-gray-900">
					<motion.div
			...
			<AnimatedSection direction="up" delay={0.4} className="relative z-10">
				<motion.div
					className="relative flex items-center justify-center overflow-hidden bg-gradient-to-b from-white to-gray-100 dark:from-gray-900 dark:to-gray-950"
					whileInView={{
						background: [
