				...
				<div className="mx-auto flex w-full max-w-5xl flex-col items-center justify-center text-center">
					...
					<div className="flex w-full flex-col items-center justify-center gap-4 px-2 sm:px-4">
						<HoverBorderGradient
							...
							className="border border-gray-300 bg-white px-8 py-3 text-center font-medium text-black text-sm transition-colors hover:bg-gray-100 sm:px-10 sm:py-4 sm:text-base"
							duration={1}
							clockwise={true}
							{...{ href: "/waitlist" }}
						>
