		...
		<AnimatePresence>
			{isOpen && (
				...
				>
					...
					{/* Modal Content */}
					<motion.div
						className="relative w-full max-w-sm rounded-xl border border-gray-700/50 bg-gray-900/95 p-6 shadow-2xl backdrop-blur-xl"
					...
					>
						...
						<div className="mb-4 text-center">
							<motion.div
								className="mx-auto mb-3 flex h-12 w-12 items-center justify-center rounded-full bg-green-500"
								initial={{ scale: 0 }}
								animate={{ scale: 1 }}
							...
							<motion.h2
								className="mb-0 font-semibold text-white text-xl"
						...
						>
							<div className="text-center">
								<div className="mb-3 inline-flex items-center gap-1 rounded-full bg-purple-500/20 px-3 py-1 font-medium text-purple-300 text-xs">
